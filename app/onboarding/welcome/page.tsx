      ...
      if (isLogin) {
        ...
        const response = await fetch("/api/auth/signup", {
          ...
          body: JSON.stringify({
            ...
            password: formData.password,
            firstName: formData.firstName,
            lastName: formData.lastName || "raj",
          }),
          credentials: "include",
        })
                ...
                <div className="relative bg-zinc-800/40 backdrop-blur-xl p-1 rounded-2xl border border-zinc-700/50 shadow-2xl">
                  <div className="grid grid-cols-2 gap-0 relative">
                    ...
                    <button
                      ...
                      className={`relative z-10 py-4 px-6 rounded-xl font-semibold text-sm transition-all duration-200 ${!isLogin ? "text-black" : "text-zinc-400 hover:text-white"
                        }`}
                    >
                      Get Started
                    </button>
